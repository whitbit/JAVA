...
import model.Informatic;
import model.Teacher;

public class EmployeeDAOXML implements EmployeeInterface{
	private List< Employee > employeeList = new ArrayList< Employee >();
	private Employee employee;
	
	public List< Employee > getEmployees(){
		Banker banker = new Banker( "Banker", 22, "Jakub", "Wielki", 2 );
		Informatic informatic = new Informatic( "Informatic", 22, "Mateusz", "Mucha", "Java / C++" );
		Teacher teacher = new Teacher( "Teacher", 26, "Magdalena", "Kosmos", "Programming in C++" );
		...
		for( int i = 0; i < employeeList.size(); i++ ){
			...
			if( employee instanceof Banker ){
				...
				System.out.println( employee.getProfession() + ": " + employee.getFirstName() + " " + employee.getLastName() + "\n   Age: " + employee.getAge() );
			} else if( employee instanceof Informatic ){
